 ...
 * This interface is used with {@link ReflectionCommandAdder}. {@link ReflectionCommandAdder} will handle commands
...
public interface CommandHandlers {
    /**
     * Pass the current command's information from {@link ReflectionCommandAdder} to this object.
     * Note that if name is null, then {@link ReflectionCommandAdder} is trying to unset the information.
     *
